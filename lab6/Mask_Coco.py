...
val_dataloader = torch.utils.data.DataLoader(coco_val_dataset, batch_size=4, shuffle=False, collate_fn=collate_fn)
# %%
coco_set= val_dataloader.dataset
img , target  = coco_set[0]
print(target)  
#%%
...
results = evaluate(model, val_dataloader, 'cuda:2')
# %%
